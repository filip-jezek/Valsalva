...
package main_ADAN_86_Heart_cellml
  ...
  model Systemic
    ...
    BG_Modules_cellml.vv_type ascending_aorta_A_module(
    ...
    BG_Modules_cellml.pv_type ascending_aorta_B_module(
    ...
    BG_Modules_cellml.pv_type ascending_aorta_C_module(
    ...
    BG_Modules_cellml.pv_type ascending_aorta_D_module(
    ...
    parameter Real u_svl(unit = "Pa") = 1000;
