...
%%
time = dymget(dl, 'Time');
t_interval = [28.45, 29.45]; % interval in seconds
...
plot(t(i_int), A_p1(i_int), 'LineWidth', 1.5, 'Color', color_b);
plot(t(i_int), A_p2(i_int), 'LineWidth', 1.5, 'Color', color_r);
plot(t(i_int), A_p3(i_int), 'LineWidth', 1.5, 'Color', color_g);
...
exportgraphics(gcf,'fig_R_SUM_A.pdf', 'ContentType','vector')
