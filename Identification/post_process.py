...
def importOptions(var_set:dict, settingsFile = 'post_process_options.json'):
    ...
    defaultOptionsString = r"""{ 
        ...
        "__inputFiles_IGNRE" : ["dsres.mat", "baseline", "dsres.mat", "valsalva"],
		"__root_path" : "..\\..\\..\\"
...
def processDyMatFile():
    ...
    try:
        ...
        fun_lib.logObjectives(var_set['__LOG_OBJECTIVES_PATH'], objectives, var_set['__SORT_COSTS_BY'], printToStdin=True)
        ...
        objectives = [fun_lib.ObjectiveVar('Simulation failed', value = e.penalty, costFunctionType=fun_lib.CostFunctionType.DistanceFromZero)]
